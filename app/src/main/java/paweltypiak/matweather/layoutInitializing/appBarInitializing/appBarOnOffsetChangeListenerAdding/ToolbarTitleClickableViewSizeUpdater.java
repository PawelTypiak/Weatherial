...
public class ToolbarTitleClickableViewSizeUpdater implements  UsefulFunctions.OnAppBarStringsChangeListener {

    private static UsefulFunctions.OnAppBarStringsChangeListener onAppBarStringsChangeListener;
    ...
    public ToolbarTitleClickableViewSizeUpdater(Activity activity){
        ...
        initializeOnToolbarTitleChangeListener();
    }
    ...
    // onToolbarTitleChangeListener

    private void initializeOnToolbarTitleChangeListener(){
        onAppBarStringsChangeListener=this;
    }

    public static UsefulFunctions.OnAppBarStringsChangeListener getOnAppBarStringsChangeListener(){
        return onAppBarStringsChangeListener;
    }
