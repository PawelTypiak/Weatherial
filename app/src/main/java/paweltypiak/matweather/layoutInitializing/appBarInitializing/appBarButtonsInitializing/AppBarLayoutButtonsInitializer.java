...
public class AppBarLayoutButtonsInitializer {
    ...
    public AppBarLayoutButtonsInitializer(Activity activity, DialogInitializer dialogInitializer){
    ...
    private void initializeNavigationDrawer(Activity activity,DialogInitializer dialogInitializer){
        navigationDrawerInitializer=new NavigationDrawerInitializer(activity,dialogInitializer);
    }

    private void initializeSearchButton(Activity activity,DialogInitializer dialogInitializer){
        new SearchButtonInitializer(activity,dialogInitializer);
    }

    private void initializeToolbarTitleButton(Activity activity,DialogInitializer dialogInitializer){
        new ToolbarTitleButtonInitializer(activity,dialogInitializer);
    }

    private void initializeYahooLogoButton(Activity activity,DialogInitializer dialogInitializer){
        new YahooLogoButtonInitializer(activity,dialogInitializer);
    }

    private void initializeFloatingActionButtonOnClickListener(Activity activity,DialogInitializer dialogInitializer){
