...
public class FloatingActionButtonInitializer {
    ...
    public FloatingActionButtonInitializer(Activity activity, DialogInitializer dialogInitializer){
        setFloatingActionButtonOnClickListener(activity,dialogInitializer);
    }

    private void setFloatingActionButtonOnClickListener(Activity activity,final DialogInitializer dialogInitializer){
