...
public class WeatherDetailsLayoutInitializer {
    ...
    private int directionIconId;
    private int northLetterIconId;
    private int speedIconId;
    private int humidityIconId;
    private int pressureIconId;
    ...
    /*private void findWeatherDetailsLayoutResources(Activity activity){
        findWeatherDetailsLayoutViews(activity);
        findWeatherDetailsLayoutDrawables();
    }*/
    ...
    /*private void findWeatherDetailsLayoutDrawables(){
        findAdditionalConditionsLayoutDrawables();
    }*/

    /*private void findAdditionalConditionsLayoutDrawables(){
        directionIconId=R.drawable.direction_icon;
        northLetterIconId=R.drawable.north_letter_icon;
        speedIconId=R.drawable.speed_icon;
        humidityIconId=R.drawable.humidity_icon;
        pressureIconId=R.drawable.pressure_icon;
    }*/
    ...
    private void setSunPathData(Activity activity,WeatherDataFormatter weatherDataFormatter){
        ...
        //isDay=weatherDataFormatter.getDay();
