...
public class WeatherGeneralInfoLayoutInitializer {
    ...
    public WeatherGeneralInfoLayoutInitializer(Activity activity,AppBarLayoutInitializer appBarLayoutInitializer){
        findWeatherGeneralInfoLayoutViews(activity);
        rotateSeeMoreImageView();
        setWeatherGeneralInfoLayoutSizes(activity,appBarLayoutInitializer);
    ...
    private void setWeatherGeneralInfoLayoutSizes(Activity activity,AppBarLayoutInitializer appBarLayoutInitializer){
    ...
    private void setCurrentTemperatureTextViewHeight(final Activity activity,final int generalWeatherLayoutHeight){
    ...
    public void updateWeatherGeneralInfoLayoutData(Activity activity,WeatherDataFormatter weatherDataFormatter,SwipeRefreshLayoutInitializer swipeRefreshLayoutInitializer){
        setConditionData(activity,weatherDataFormatter,swipeRefreshLayoutInitializer);
    ...
    private void setConditionData(Activity activity, WeatherDataFormatter weatherDataFormatter, final SwipeRefreshLayoutInitializer swipeRefreshLayoutInitializer){
        ...
        Picasso.with(activity.getApplicationContext()).load(conditionDrawableId).into(conditionImageView, new Callback() {
            ...
            public void onSuccess() {
                //fadeInWeatherLayout();
                fadeInWeatherLayout(swipeRefreshLayoutInitializer);
    ...
    private void fadeInWeatherLayout(final SwipeRefreshLayoutInitializer swipeRefreshLayoutInitializer){
    ...
    public void updateWeatherGeneralInfoLayoutTheme(Activity activity,WeatherLayoutThemeColorsUpdater themeColorsUpdater){
