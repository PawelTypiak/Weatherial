...
public class FirstLaunchLoadingFragmentMainActivityStartingInitializer {

    public FirstLaunchLoadingFragmentMainActivityStartingInitializer(Activity activity,
